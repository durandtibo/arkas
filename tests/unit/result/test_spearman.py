...
def test_spearman_correlation_result_y_true() -> None:
...
def test_spearman_correlation_result_y_true_2d() -> None:
    assert objects_are_allclose(
        SpearmanCorrelationResult(
...
def test_spearman_correlation_result_y_pred() -> None:
    assert objects_are_allclose(
        SpearmanCorrelationResult(
            y_true=np.array([1, 2, 3, 4, 5]), y_pred=np.array([5, 4, 3, 2, 1])
        ).y_pred,
...
def test_spearman_correlation_result_y_pred_2d() -> None:
    assert objects_are_allclose(
        SpearmanCorrelationResult(
            y_true=np.array([[1, 2, 3], [4, 5, 6]]), y_pred=np.array([[6, 5, 4], [3, 2, 1]])
        ).y_pred,
...
def test_spearman_correlation_result_y_pred_incorrect_shape() -> None:
...
def test_spearman_correlation_result_equal_false_different_y_true() -> None:
    assert not SpearmanCorrelationResult(
        y_true=np.array([1, 2, 3, 4, 5]), y_pred=np.array([1, 2, 3, 4, 5])
    ).equal(
        SpearmanCorrelationResult(
            y_true=np.array([1, 0, 0, 1, 0]), y_pred=np.array([1, 2, 3, 4, 5])
        )
    )


def test_spearman_correlation_result_equal_false_different_y_pred() -> None:
    assert not SpearmanCorrelationResult(
        y_true=np.array([1, 2, 3, 4, 5]), y_pred=np.array([1, 2, 3, 4, 5])
    ).equal(
        SpearmanCorrelationResult(
...
def test_spearman_correlation_result_compute_metrics_empty() -> None:
    result = SpearmanCorrelationResult(y_true=np.array([]), y_pred=np.array([]))
    assert objects_are_allclose(
