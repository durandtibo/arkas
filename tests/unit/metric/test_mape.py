...
def test_mean_absolute_percentage_error_ignore_nan() -> None:
    assert objects_are_equal(
        mean_absolute_percentage_error(
            y_true=np.array([float("nan"), 2, 3, 4, 5, float("nan")]),
            y_pred=np.array([1, 2, 3, 4, float("nan"), float("nan")]),
...
def test_mean_absolute_percentage_error_ignore_nan_y_true() -> None:
    assert objects_are_equal(
        mean_absolute_percentage_error(
...
def test_mean_absolute_percentage_error_ignore_nan_y_pred() -> None:
    assert objects_are_equal(
        mean_absolute_percentage_error(
