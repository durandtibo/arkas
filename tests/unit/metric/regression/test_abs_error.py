...
def test_mean_absolute_error_drop_nan() -> None:
    assert objects_are_equal(
        mean_absolute_error(
            y_true=np.array([float("nan"), 2, 3, 4, 5, float("nan")]),
            y_pred=np.array([1, 2, 3, 4, float("nan"), float("nan")]),
...
def test_mean_absolute_error_drop_nan_y_true() -> None:
    assert objects_are_equal(
        mean_absolute_error(
...
def test_mean_absolute_error_drop_nan_y_pred() -> None:
    assert objects_are_equal(
        mean_absolute_error(
...
def test_median_absolute_error_drop_nan() -> None:
    assert objects_are_equal(
        median_absolute_error(
            y_true=np.array([float("nan"), 2, 3, 4, 5, float("nan")]),
            y_pred=np.array([1, 2, 3, 4, float("nan"), float("nan")]),
...
def test_median_absolute_error_drop_nan_y_true() -> None:
    assert objects_are_equal(
        median_absolute_error(
            y_true=np.array([1, 2, 3, 4, 5, float("nan")]),
            y_pred=np.array([1, 2, 3, 4, 5, 0]),
...
def test_median_absolute_error_drop_nan_y_pred() -> None:
    assert objects_are_equal(
        median_absolute_error(
            y_true=np.array([1, 2, 3, 4, 5, 0]),
            y_pred=np.array([1, 2, 3, 4, 5, float("nan")]),
