...
################################################
#     Tests for mean_squared_error_metrics     #
################################################
...
def test_mean_squared_error_metrics_incorrect() -> None:
    assert objects_are_equal(
        mean_squared_error_metrics(y_true=np.array([4, 3, 2, 1]), y_pred=np.array([1, 2, 3, 4])),
...
def test_mean_squared_error_metrics_empty() -> None:
    assert objects_are_equal(
        mean_squared_error_metrics(y_true=np.array([]), y_pred=np.array([])),
