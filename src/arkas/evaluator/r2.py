r"""Contain the R^2 (coefficient of determination) regression score
evaluator."""

from __future__ import annotations

__all__ = ["R2ScoreEvaluator"]
...
from arkas.result import R2ScoreResult, Result
...
class R2ScoreEvaluator(BaseLazyEvaluator[R2ScoreResult]):
    ...
    def _compute_result(self, data: pl.DataFrame) -> R2ScoreResult:
        return R2ScoreResult(
