r"""Contain the Pearson correlation evaluator."""

from __future__ import annotations

__all__ = ["PearsonCorrelationEvaluator"]
...
from arkas.result import PearsonCorrelationResult, Result
...
class PearsonCorrelationEvaluator(BaseLazyEvaluator[PearsonCorrelationResult]):
    r"""Implement the Pearson correlation evaluator.
    ...
    def evaluate(self, data: pl.DataFrame, lazy: bool = True) -> PearsonCorrelationResult | Result:
        logger.info(
    ...
    def _compute_result(self, data: pl.DataFrame) -> PearsonCorrelationResult:
