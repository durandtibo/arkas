...
class MultilabelAveragePrecisionEvaluator(BaseLazyEvaluator[MultilabelAveragePrecisionResult]):
    ...
    def evaluate(
        ...
        logger.info(
            f"Evaluating the multilabel average precision | y_true={self._y_true} | "
