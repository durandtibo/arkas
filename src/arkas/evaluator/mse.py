r"""Contain the mean squared error (MSE) evaluator."""

from __future__ import annotations

__all__ = ["MeanSquaredErrorEvaluator"]
...
from arkas.result import MeanSquaredErrorResult, Result
...
class MeanSquaredErrorEvaluator(BaseLazyEvaluator[MeanSquaredErrorResult]):
    r"""Implement the mean squared error (MSE) evaluator.
    ...
    def _compute_result(self, data: pl.DataFrame) -> MeanSquaredErrorResult:
        return MeanSquaredErrorResult(
