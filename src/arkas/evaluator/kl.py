r"""Contain the Kullback-Leibler (KL) divergence between two
distributions evaluator."""

from __future__ import annotations

__all__ = ["KLDivEvaluator"]
...
from arkas.result import KLDivResult, Result
...
class KLDivEvaluator(BaseLazyEvaluator[KLDivResult]):
    ...
    def evaluate(self, data: pl.DataFrame, lazy: bool = True) -> KLDivResult | Result:
        logger.info(
    ...
    def _compute_result(self, data: pl.DataFrame) -> KLDivResult:
        return KLDivResult(
